# Run-Audition.ps1
# Launches the Seiyuu Audition GUI.
#
...
# reached by running the generator's irodori_batch.py through uv.
#
# "irodori_root" and "temp_root" in settings.json are what point this tool
# at that install and at its scratch folder.
