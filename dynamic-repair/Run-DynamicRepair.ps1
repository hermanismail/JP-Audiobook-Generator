# Run-DynamicRepair.ps1
# Launches the Dynamic Repair GUI.
#
...
# right here. It needs only customtkinter, pillow and mutagen - the TTS runs
# in the Irodori-TTS venv through the generator's irodori_batch.py, and
